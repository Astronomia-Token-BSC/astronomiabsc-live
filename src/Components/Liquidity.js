...
import bitQueryLogo from '../images/bitquery.png';
              ...
              <span className="text-muted small">(Includes locked, excludes burned)</span>
                ...
                <div className="market-cap-wrap">
                 <h3 class="head-title"> {this.state.symbol}/{this.convertPair(this.state.pair)} LP Holdings: </h3>
                  ...
                  <p className="pt-1">
                  <a href="https://exchange.pancakeswap.finance/#/swap?outputCurrency=0x6AE97E66EeC23B4fDF77Cd4cA423ECfBD439c39e" target="_blank">{this.state.exchange} </a>
