...
function BuySellCard() {
    ...
    const [defaultSymbol1, setDefaultSymbol1] = useState("")
                                ...
                                <div className='tradeform-combo__token'>
                                    <div className="input-group-prepend">
                                        <span className="input-group-text hv-29313a" style={{
                                            ...
                                            <img src={bnbIcon} style={{ width: '25px', height: '25px', borderRadius: '50%' }} />
                                            &nbsp; {bnb} &nbsp;
                                            {/* 
                                ...
                                <div className='tradeform-combo__token'>
                                    <div className="input-group-prepend">
                                        <span className="input-group-text hv-29313a" style={{
                                            ...
                                            <img src={astronIcon} style={{ width: '25px', height: '25px', borderRadius: '50%' }} />
                                            &nbsp; {astronName} &nbsp;
