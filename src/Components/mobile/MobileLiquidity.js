...
export default class MobileLiquidity extends Component {
  intervalID;
    ...
    fetch('https://api.astronomia.finance/basic/0x6AE97E66EeC23B4fDF77Cd4cA423ECfBD439c39e.json')
      ...
      .then(data => {
        ...
        this.setState({
          ...
          total_supply: (parseInt(data['total_supply'])).toLocaleString('en-US', { maximumFractionDigits: 0, minimumFractionDigits: 0 }),
  ...
  render() {
    ...
    return (
            ...
            <div className="chart-sidebar p-1">
              ...
              <h3 class="head-title">Market Cap</h3>
                 <span className="text-muted small">(Includes locked, excludes burned)</span> 
                  <p className="pt-1 head__sum">${this.state.market_cap}</p>
                ...
                <p className="pt-1 head__sum">{this.state.total_supply}</p>
                </div>

                 <div className="mobile--item"> 
                 <h3 class="head-title">{this.state.symbol}/{this.convertPair(this.state.pair)} LP Holdings</h3>
                  <span> {this.state.balance_wbnb} {this.convertPair(this.state.pair)}  <a href="https://exchange.pancakeswap.finance/#/swap?outputCurrency=0x6AE97E66EeC23B4fDF77Cd4cA423ECfBD439c39e" target="_blank">{this.state.exchange} </a></span> 
                  <p className="pt-1 head__sum">${this.state.balance_usd}</p>
                ...
                <h3 class="head-title">Holders</h3>
                  ...
                  <p className="pt-1 head__sum">{this.state.holders}</p>   
                </div>
                {/*
 ...
 { /* 
                <div className="traders__wrapper">
                  <ul>
                    ...
                    <li>
                      <a target="_blank" href="https://bscscan.com/token/0x6ae97e66eec23b4fdf77cd4ca423ecfbd439c39e">
                        <img width="17px" height="17px" src={bscScanLogo} alt="trader-icon" />
                        ASTRON Transactions
                      </a>
                    </li>
                    <li>
                      <a target="_blank" href="https://bscscan.com/address/0x6ae97e66eec23b4fdf77cd4ca423ecfbd439c39e#code">
                        <img width="17px" height="17px" src={bscScanLogo} alt="trader-icon" />
                        ASTRON Contract
                      </a>
                    </li>
                    <li>
                      <a target="_blank" href="https://bscscan.com/token/0x6ae97e66eec23b4fdf77cd4ca423ecfbd439c39e#balances">
                        <img width="17px" height="17px" src={bscScanLogo} alt="trader-icon" />
                        ASTRON Holders
                      </a>
                    </li>
                    ...
                    <li>
                      <a target="_blank" href="https://bscscan.com/token/0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c?a=0x18e2758cC1e098760cceb32A90dBB272645AE726#tokenAnalytics">
                        <img width="17px" height="17px" src={bscScanLogo} alt="trader-icon" />
                        ASTRON Chart
                      </a>
                    </li>
                    ...
                    <li>
                      <a target="_blank" href="https://bscscan.com/token/tokenholderchart/0x6ae97e66eec23b4fdf77cd4ca423ecfbd439c39e">
                        <img width="17px" height="17px" src={bscScanLogo} alt="trader-icon" />
                        ASTRON Holder Chart
                      </a>
                    </li>
