             ...
             { /* <span><Moment className="text-muted small" fromNow parse="YYYY-MM-DD HH:mm:ss">{feature.time[0]} {feature.time[1]}</Moment></span> */ }
                  ...
                  <div key={'td6'+index} className="td tx d-none d-lg-block">
                    <span>
                      ...
                      <span><a className="track-value" target="_blank" href={'https://bscscan.com/tx/' + feature.hash}>Track</a></span>
...
<a class="btn btn-progress load" onClick={() => this.loadMore()}>{this.state.loadSpinner} {this.state.loadMoreTrades}</a>
   </div>
